...
use feos_core::{
    ...
    Derivative, Model, HelmholtzEnergy, HelmholtzEnergyDual, State, StateHD,
};
...
fn a_res<D: DualNum<f64>, E: Model>(inp: (&Arc<E>, &StateHD<D>)) -> D
where
...
fn bench_dual_numbers<E: Model>(c: &mut Criterion, group_name: &str, state: State<E>) {
