...
use feos_core::{
    ...
    Contributions, DensityInitialization, Model, PhaseEquilibrium, State,
};
...
fn critical_point<E: Model>((eos, n): (&Arc<E>, Option<&SIArray1>)) {
...
fn critical_point_binary<E: Model>((eos, tp): (&Arc<E>, SINumber)) {
...
fn dew_point<E: Model>((eos, t, y): (&Arc<E>, SINumber, &Array1<f64>)) {
...
fn bench_states<E: Model>(c: &mut Criterion, group_name: &str, eos: &Arc<E>) {
